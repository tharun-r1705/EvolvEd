...
const TRENDS = [
  ...
  { title: 'Vector Databases', category: 'database', trendScore: 82, description: 'Vector databases (Pinecone, Weaviate, Chroma, pgvector) are critical infrastructure for AI applications, enabling semantic search and RAG (Retrieval-Augmented Generation).', dataPoints: trend(65, 8) },
  { title: 'PostgreSQL', category: 'database', trendScore: 89, description: 'PostgreSQL is the most trusted open-source relational database. Its JSON support, full-text search, and extensions (pgvector, PostGIS) make it a versatile choice for modern apps.', dataPoints: trend(85, 2) },
  { title: 'Redis', category: 'database', trendScore: 86, description: 'Redis is the go-to for caching, session storage, rate limiting, and real-time leaderboards. Redis Stack adds search, JSON, and time-series capabilities.', dataPoints: trend(83, 1) },
  ...
  { title: 'Elasticsearch', category: 'database', trendScore: 77, description: 'Elasticsearch powers full-text search, log analytics, and observability for organizations at scale. The Elastic Stack (ELK) is a standard for centralized logging and monitoring.', dataPoints: trend(74, 2) },
];
