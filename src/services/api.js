...
export const adminService = {
  ...
  updatePlacementDrive:  (id, data)   => api.patch(`/admin/placement-drives/${id}`, data),
  getRecruiters:         (params)     => api.get('/admin/recruiters', { params }),
  inviteRecruiter:       (data)       => api.post('/admin/recruiters/invite', data),
  ...
  recalculateScores:     ()           => api.post('/admin/scores/recalculate'),
  generateReport:        ()           => api.get('/admin/reports/generate', { responseType: 'blob' }),
};
